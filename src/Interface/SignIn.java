...
public class SignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        kGradientPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 6, -1, 28));
    ...
    if (password.equals(repassword)) {
        try {
            String sql = "INSERT INTO `register`(`id`, `user_name`, `email`, `password`, `re_password`) values (?,?,?,?,?)";
