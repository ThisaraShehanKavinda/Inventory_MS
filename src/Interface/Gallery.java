...
public class Gallery extends javax.swing.JFrame {
    ...
    private JButton getDisplayButton() {
        ...
        JButton button = new JButton("Display Stock");
        return button;
    }
     ...
     private void displayHalls() {
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT item_id, sale_price, image FROM stock");

            // Create a JLabel for each hall and add it to the gallery panel
            while (resultSet.next()) {
                String hallId = resultSet.getString("item_id");
                String name = resultSet.getString("sale_price");
                ...
                label.setText("<html><b>Item ID:</b> " + hallId + "<br><b>Price:</b> " + name + "</html>");
